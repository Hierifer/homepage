  ...
  return (
    <React.Fragment>
      <Header dark={scrollAnimating} />
        <div ref={holdRef} className="relative" style={{width: '100%', height: '350vh'}}>
          <div ref={wholeRef} className="w-screen h-screen flex justify-center overflow-hidden bottom-0">
            <div className="absolute inset-1/2 w-full text-white" style={{zIndex: 20, transform: 'translate(-50%, -40%)', textAlign: 'center'}}>
              <p ref={t1Ref} className="absolute left-1/2 text-5xl opacity-100" style={{transform: 'translate(-50%, -50%)'}}>人生如繁星，精彩却孤独</p>
              <p ref={t2Ref} className="absolute left-1/2 text-5xl opacity-0" style={{transform: 'translate(-50%, -50%)'}}>我们，观星者们</p>
              <p ref={t3Ref} className="absolute left-1/2 text-5xl opacity-0" style={{transform: 'translate(-50%, -50%)'}}>将发现他人与你的连接</p>
            </div>
        ...
        <Element name="product">
          <div ref={productRef} className="w-screen h-screen flex justify-between">
        ...
        <Element name="about">
          <div ref={aboutRef} className="w-screen h-screen flex justify-center">
